                        ...
                        for (i = 0; i < CHUNK_WIDTH;) {
                            ...
                            if (mask[n] != nullptr) {
                                ...
                                if (!mask[n]->transparent) {
                                     ...
                                     *
                                     * We pass mask[n] to the function, which is an instance of 
									 * the VoxelFace class containing all the attributes of the 
									 * face - which allows for variables to be passed to shaders 
