#include <time.h>
#include "graphics.h"
#include "cplib/cpmath.h"
#include "cplib/cplog.h"
#include "glad/glad.h"
#include "GLFW/glfw3.h"
#include "gllib.h"
#include "cplib/cptime.h"
...
static void loadShaders(void)
{
    ...
    shaderTerrainInitial = gllib_makeCompute("resources/shaders/compute/initial.glsl");
    shaderDFGenPrepare = gllib_makeCompute("resources/shaders/compute/dfGenPrepare.glsl");
    shaderDFGenX = gllib_makeCompute("resources/shaders/compute/dfGenXPass.glsl");
    shaderDFGenY = gllib_makeCompute("resources/shaders/compute/dfGenYPass.glsl");
    shaderDFGenZ = gllib_makeCompute("resources/shaders/compute/dfGenZPass.glsl");
